...
banner: /images/creating-a-theme-toggle-using-sass/og.webp
date: 2023-03-05
tags: [sass, javascript, design]
---
...
In this article, we'll examine at how to use Sass to create a theme toggle. Sass is a powerful preprocessor that allows for the creation of modular and reusable CSS. We can create a theme option much more quickly by using Sass.
