...
export const tools = [
  ...
  },
  {
    id: 2,
    icon: (
      <svg aria-hidden="true" viewBox="0 0 200 300">
        <path
  ...
  },
  {
    id: 3,
    icon: (
      <svg aria-hidden="true" viewBox="-11.9 -2 1003.9 995.6">
        <path
  ...
  },
  {
    id: 4,
    icon: (
      <svg aria-hidden="true" viewBox="0 0 256 249" preserveAspectRatio="xMinYMin meet">
  ...
  },
  {
    id: 5,
    icon: (
      <svg aria-hidden="true" viewBox="0 0 2195.9 2430.9" xmlSpace="preserve">
        <g>
          <path
            className="st0"
            fill="#F9AB00"
