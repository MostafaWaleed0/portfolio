export const tools = [
  {
    id: 1,
    icon: (
      <svg aria-hidden="true" viewBox="0 0 60 100" width="1.3em" height="1.3em">
        <defs>
          <linearGradient
            id="a"
            x1="82.85"
          ...
          >
            <stop offset="0" stopColor="#6c56cc"></stop>
            <stop offset="1" stopColor="#9785e5"></stop>
          </linearGradient>
        </defs>
        <polygon
          points="44.61 0 12.91 17.52 0 45.45 19.57 90.47 47.35 100 52.44 89.8 63 26.39 44.61 0"
          fill="#34208c"
        ></polygon>
        <polygon
          points="63 26.39 43.44 14.41 16.43 35.7 47.35 100 52.44 89.8 63 26.39"
          fill="url(#a)"
        ></polygon>
        <polygon
          points="63 26.39 63 26.39 44.61 0 43.44 14.41 63 26.39"
          fill="#af9ff4"
        ></polygon>
        <polygon
          points="43.44 14.41 44.61 0 12.91 17.52 16.43 35.7 43.44 14.41"
          fill="#4a37a0"
        ></polygon>
        <polygon
          points="16.43 35.7 19.57 90.47 47.35 100 16.43 35.7"
          fill="#4a37a0"
        ></polygon>
      </svg>
    ),
  ...
  },
  {
    id: 7,
    icon: (
      <svg aria-hidden="true" viewBox="0 0 48 48" width="1.6em" height="1.6em">
        <path
          fill="#2196f3"
  ...
  },
  {
    id: 10,
    icon: (
      <svg aria-hidden="true" viewBox="0 0 175 165" width="2em" height="2em">
        <path
          className="fill-inverse"
          fillRule="evenodd"
          clipRule="evenodd"
          d="M78.326 35.5493C87.6678 33.1657 93.7613 32.6774 105.545 35.5493C108.602 31.8082 124.449 16.5774 131.883 26.0633C139.317 35.5493 135.809 46.3057 132.812 49.016C137.374 71.7992 138.743 96.6021 140.497 107.246C143.302 124.261 94.5869 149.369 92.1799 149.369C89.7728 149.369 40.547 124.245 42.9489 107.246C44.5079 96.2115 49.3511 64.9388 52.4766 50.117C48.4926 49.016 45.3778 33.9991 53.6593 26.0633C61.9408 18.1276 74.1336 31.9221 78.326 35.5493ZM70.8922 75.6106C70.8922 64.9388 81.536 46.3057 92.1798 46.3057C102.824 46.3057 114.65 64.9388 114.65 75.6106C114.65 90.3612 99.6173 95.0757 92.1798 95.0757C84.7423 95.0757 70.8922 90.3612 70.8922 75.6106ZM92.1798 60.6193C83.2485 60.6193 81.3672 62.5487 81.3672 65.2843C81.3672 68.0199 84.236 71.7145 92.1798 71.7145C100.124 71.7145 102.688 68.3239 102.688 65.2843C102.688 62.2447 101.111 60.6193 92.1798 60.6193Z"
          fill="black"
        />
      </svg>
    ),
  ...
  },
  {
    id: 11,
    icon: (
      <svg aria-hidden="true" viewBox="0 0 48 48" width="2em" height="2em">
        <path
          fill="#03A9F4"
